(function(win, doc) {
	  ...
	  */
	  ...
	  var person1 = new Person('Teste A', 'Last A');
	  var person2 = new Person('Teste B', 'Last B');
	  ...
	  */
	  ...
	  console.log(sum(6,7));
	  console.log(sum(6,7,1,2,1,1,1,1,1));
	  ...
	  */
	  ...
	  function justNumbers(entrada) {
		  ...
		  console.log("just numbers:", entrada);
		  return entrada;
	  }
	  ...
	  */
	  ...
	  console.log(sum.apply(null, Array.from(numbers)));
