...
brasil.unshift('Rondonia', 'Amazônia', 'Roraima');
console.log(brasil);
...
*/
var nordeste = ['Macapá', 'Piauí', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia', 'Ceará', 'Paraíba', 'Rio Grande do Norte'];
...
var possuiMaisDe7Letras = brasil.every(function(item) {
    return item.length > 7;
});
if (possuiMaisDe7Letras) {
